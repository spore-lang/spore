...
fn set_new() -> List[I32] cost [1, 1, 0, 0]
spec {
...
fn set_contains(s: List[I32], item: I32) -> Bool cost [3, 0, 0, 0]
spec {
...
fn set_len(s: List[I32]) -> I32 cost [3, 0, 0, 0]
spec {
...
fn set_is_empty(s: List[I32]) -> Bool cost [4, 0, 0, 0]
spec {
    example "empty": set_is_empty(set_new()) == true
