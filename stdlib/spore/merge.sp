...
spec {
    example "adds_new_member": contains(merge_unique_i32([1], [2]), 2) == true
    example "overlap_stays_unique": len(merge_unique_i32([1], [1, 1])) == 1
}
{
...
spec {
    ...
    example "deduplicates_across_parts": len(merge_all_i32([[1, 2], [2, 3]])) == 3
}
{
