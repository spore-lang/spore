...
fn sign(x: I32) -> I32 cost [2, 0, 0, 0]
spec {
...
fn clamp(x: I32, lo: I32, hi: I32) -> I32 cost [5, 0, 0, 0]
spec {
...
fn is_even(n: I32) -> Bool cost [2, 0, 0, 0]
spec {
...
fn is_odd(n: I32) -> Bool cost [2, 0, 0, 0]
spec {
...
fn is_positive(n: I32) -> Bool cost [1, 0, 0, 0]
spec {
...
fn is_negative(n: I32) -> Bool cost [1, 0, 0, 0]
spec {
...
fn is_zero(n: I32) -> Bool cost [1, 0, 0, 0]
spec {
...
fn pow(base: I32, exp: I32) -> I32 cost [64, 0, 0, 0]
spec {
...
fn lcm(a: I32, b: I32) -> I32 cost [130, 0, 0, 0]
spec {
...
fn div_ceil(a: I32, b: I32) -> I32 cost [3, 0, 0, 0]
spec {
...
fn sum_list(xs: List[I32]) -> I32 cost [1000, 0, 0, 0]
spec {
...
fn product_list(xs: List[I32]) -> I32 cost [1000, 0, 0, 0]
spec {
...
fn checked_div(a: I32, b: I32) -> Option[I32] cost [2, 0, 0, 0] {
