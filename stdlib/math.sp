...
fn sign(x: I32) -> I32 cost [3, 0, 0, 0]
spec {
...
fn is_even(n: I32) -> Bool cost [3, 0, 0, 0]
spec {
...
fn is_odd(n: I32) -> Bool cost [3, 0, 0, 0]
spec {
...
fn div_ceil(a: I32, b: I32) -> I32 cost [6, 0, 0, 0]
spec {
...
fn product_list(xs: List[I32]) -> I32 cost [1000, 2, 0, 0]
spec {
